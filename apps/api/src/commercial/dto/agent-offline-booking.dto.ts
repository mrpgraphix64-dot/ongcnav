...
export class AgentOfflineBookingDto {
  @ApiProperty({ example: 'Suresh Patel', description: 'Customer full name' })
  @IsString()
  ...
  @ApiProperty({
    ...
    description: 'Ticket type: COMMERCIAL_DAILY, COMMERCIAL_SEASON, COMMERCIAL_MANDLI, COMMERCIAL_ANY_DAY',
  })
  ...
  @ApiProperty({ example: 2, description: 'Number of passes (1 to 10)' })
